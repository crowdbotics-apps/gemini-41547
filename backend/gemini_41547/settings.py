"""
Django settings for gemini_41547 project.
...
ROOT_URLCONF = 'gemini_41547.urls'
...
WSGI_APPLICATION = 'gemini_41547.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gemini_41547 API",
    "DESCRIPTION": "API documentation for gemini_41547 App",
    "VERSION": "v1",
}
